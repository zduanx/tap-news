...
class CloudAMQPClient:
    ...
    # A safer way to sleep than calling time.sleep() directly that would keep the adapter from ignoring frames sent from the broker.
    # The connection will “sleep” or block the number of seconds specified in duration in small intervals.
