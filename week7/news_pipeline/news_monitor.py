...
SLEEP_TIME_IN_SECONDS = 1400

redis_client = redis.StrictRedis(REDIS_HOST, REDIS_PORT)
NEWS_SOURCES = ['cnn', 'abc-news', 'bbc-sport', 'bbc-news', 'the-wall-street-journal', 'the-economist', 'msnbc', 'ign', 'techcrunch', 'bloomberg', 'reuters', 'nfl-news', 'national-geographic', 'time']
